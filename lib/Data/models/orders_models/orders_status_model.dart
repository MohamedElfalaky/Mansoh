...
OrdersStatusModel ordersStatusModelFromJson(dynamic str) => OrdersStatusModel.fromJson(str);

String ordersStatusModelToJson(OrdersStatusModel data) => json.encode(data.toJson());
